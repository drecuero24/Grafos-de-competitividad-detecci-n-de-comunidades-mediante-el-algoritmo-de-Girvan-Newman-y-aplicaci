...
# # GRAFOS DE COMPETITIVIDAD: DETECCIÓN DE COMUNIDADES MEDIANTE EL ALGORITMO DE GIRVAN-NEWMAN Y APLICACIÓN AL ESTUDIO DEL IBEX 35
...
nx.draw_networkx_labels(G_inv, pos_inv, font_size=11, bbox=dict(ec="black",boxstyle="round",facecolor="white",pad=0.3,
                        alpha=0.6), font_weight='normal', font_family='Verdana', horizontalalignment='center', 
